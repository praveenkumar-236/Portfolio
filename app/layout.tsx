...
export const metadata: Metadata = {
  ...
  description:
    "Praveen Kumar is FullStack Web Developer and Currently working at Netclues India Private Limited",
  keywords: "Praveenktech, Praveenthakur, Praveenkumar portfolio",
};
